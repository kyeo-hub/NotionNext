const CONFIG = {
  ...
  //播客列表卡片
  GITBOOK_POST_LIST_COVER: true, // 文章列表显示图片封面
  GITBOOK_POST_LIST_COVER_FORCE: false, // 即使没有封面也将站点背景图设置为封面
  GITBOOK_POST_LIST_PREVIEW: false, // 显示文章预览
  GITBOOK_POST_LIST_ANIMATION: false, // 博客列表淡入动画
